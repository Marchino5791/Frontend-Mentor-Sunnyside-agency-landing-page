...
export default function Footer() {
    return (
        <footer className="footer">
            <img src={logo} className="footer__logo" alt="Sunnyside's logo" />
            ...
            <div className="footer__social">
                <a href="https://facebook.com" target="_blank" title="Sunnyside's facebook page" rel="noreferrer">
                ...
                <a href="https://instagram.com" target="_blank" title="Sunnyside's instagram page" rel="noreferrer">
                ...
                <a href="https://twitter.com" target="_blank" title="Sunnyside's twitter page" rel="noreferrer">
                ...
                <a href="https://pinterest.com" target="_blank" title="Sunnyside's pinterest page" rel="noreferrer">
            ...
            <div class="attribution">
                ...
                Coded by <a href="https://www.frontendmentor.io/profile/Marchino5791" target="_blank">Marco Paolino</a>.
            </div>
        </footer>
    )
}